...
if( have_rows('archive_links') ):
  ...
  while( have_rows('archive_links') ) : the_row();
      ...
      <a class="flex flex-col border md:flex-row group items-center bg-gray-100 md:bg-white rounded-md overflow-hidden hover:ring-4 hover:ring-highlight focus:ring-4 focus:ring-highlight" href="<?php the_sub_field('link');?>" rel="bookmark" aria-label="Read <?php echo $title;?>">
      <?php if($img) {
